  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20 pt-32 overflow-x-hidden">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <ArrowRight className="w-4 h-4 rotate-180" /> Zpět na úvod
        </button>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="space-y-8">
            ...
            <div className="glass rounded-[2rem] p-8 border border-white/20 flex items-start gap-4 shadow-ultimate">
          ...
          <div className="lg:sticky lg:top-32 h-fit">
            <div className="bg-slate-900 rounded-[3rem] p-10 text-white shadow-2xl shadow-brand-primary/10 overflow-hidden relative">
              <div className="absolute top-0 right-0 w-64 h-64 bg-brand-primary/10 rounded-full blur-3xl -mr-32 -mt-32" />
              
              <h2 className="text-[10px] font-black text-brand-primary uppercase tracking-widest mb-10">Odhadované náklady</h2>
              ...
              <div className="space-y-6 mb-12">
                ...
                <div className="flex justify-between items-end pt-4">
                  <span className="text-brand-primary text-sm font-black uppercase tracking-widest">Celkem</span>
              ...
              <button className="btn-ultimate-primary w-full py-6 text-sm flex items-center justify-center gap-3 group">
