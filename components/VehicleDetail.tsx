...
const VehicleDetail: React.FC<VehicleDetailProps> = ({ vehicle, onBack, onBook }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 overflow-x-hidden">
      <button 
        onClick={onBack}
        className="mb-8 flex items-center gap-2 text-[11px] font-bold uppercase tracking-wider text-slate-400 hover:text-slate-900 transition-colors"
      >
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-start">
        ...
        <div className="space-y-12">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-4">{vehicle.name}</h1>
